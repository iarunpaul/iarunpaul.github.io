...
This blog post is inspired by [the great article in C#](https://www.c-sharpcorner.com/article/grpc-service-create-using-net-core-6-0-entity-framework-for-crud-operation/) Corner by Shirsendu Nandi. But the post is old that the `Protobuf` library is not working as explained in the post. That is why this post.
